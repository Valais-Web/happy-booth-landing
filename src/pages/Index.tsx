        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-2 space-y-6 lg:space-y-8 text-left">
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-white/95 leading-relaxed font-medium">
              ...
              <div className="flex flex-col sm:flex-row sm:flex-wrap lg:flex-nowrap gap-3 sm:gap-4">
                <div className="bg-white/15 backdrop-blur-sm border border-white/20 rounded-full px-4 lg:px-6 py-3 flex items-center space-x-2 justify-center sm:justify-start">
              ...
              <div className="pt-4 lg:pt-8">
                <Button size="lg" className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-black font-bold text-lg lg:text-xl px-8 lg:px-12 py-4 lg:py-6 rounded-full shadow-2xl transform hover:scale-105 transition-all duration-300 w-full sm:w-auto" onClick={() => scrollToSection('contact-form')}>
                  Demander une offre
            ...
            <div className="lg:col-span-1 relative flex justify-center">
              <div className="relative w-full max-w-sm lg:max-w-none">
                ...
                <div className="absolute -bottom-4 left-1/2 lg:left-auto lg:-bottom-6 lg:-left-6 transform -translate-x-1/2 lg:transform-none bg-white/95 backdrop-blur-sm rounded-lg p-3 shadow-lg border border-gray-200">
