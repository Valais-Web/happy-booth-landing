      ...
      <section className="relative pt-36 pb-20 md:pt-40 md:pb-24 overflow-hidden">
        ...
        <div className="container mx-auto px-5 max-w-[1320px]">
          <div className="max-w-5xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-white border border-ink/10 px-4 py-2 rounded-full text-sm font-medium text-ink-soft mb-7">
              <span className="w-2 h-2 bg-mint rounded-full animate-pulse-dot"></span>
            ...
            <h1 className="font-display font-bold text-[clamp(2.75rem,7.5vw,6.5rem)] leading-[0.95] tracking-tight mb-8">
              ...
              <span className="block">
                ...
                <span className="h1-highlight">Suisse Romande</span>
              </span>
            </h1>
